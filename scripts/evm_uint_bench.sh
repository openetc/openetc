...
./target/release/openetc-evm stats --code $CODE1 --gas 4402000
echo "^^^^ usize"
./target/release/openetc-evm stats --code $CODE1
echo "^^^^ U256"
...
./target/release/openetc-evm stats --code $CODE2 --gas 143020115
echo "^^^^ usize"
./target/release/openetc-evm stats --code $CODE2
echo "^^^^ U256"
