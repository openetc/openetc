...
echo "_____ Build OpenETC and tools _____"
...
cp --verbose target/release/openetc.exe artifacts/openetc.exe
cp --verbose target/release/openetc-evm.exe artifacts/openetc-evm.exe
